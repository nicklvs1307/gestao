...
export const NAV_CATEGORIES: NavCategory[] = [
  ...
  },
  {
    ...
    module: 'stock',
    items: [
      { label: "Painel Geral", path: "/stock/dashboard", icon: LayoutDashboard, permission: 'stock:view' },
      ...
      { label: "Grupos de Ingrediente", path: "/stock/ingredient-groups", icon: Layers, permission: 'stock:manage' },
      { label: "Histórico de Posição de Estoque", path: "/stock/history", icon: History, permission: 'stock:view' },
      { label: "Ingredientes e Insumos", path: "/stock/ingredients", icon: Package, permission: 'stock:manage' },
