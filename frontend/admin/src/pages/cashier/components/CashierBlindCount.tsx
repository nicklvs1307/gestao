  ...
  return (
    <Card className="p-0 border-slate-200 shadow-md overflow-hidden bg-white" noPadding>
      <div className="px-4 py-3 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
        ...
        <div className="flex items-center gap-1 bg-slate-900 text-white px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-widest">
            ...
            >
              <div className="flex justify-between items-start mb-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800 uppercase tracking-tight leading-none">
                      {m.label}
                    </p>
                ...
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className={cn(
                      'w-full h-10 bg-white border border-slate-200 rounded-md pl-7 pr-2 text-xs font-bold focus:border-slate-900 outline-none shadow-sm transition-all tabular-nums',
                ...
                {m.id === 'cash' ? (
                  <button
                    ...
                    className="h-10 px-3 bg-emerald-50 text-emerald-600 hover:bg-emerald-600 hover:text-white border border-emerald-100 rounded-md transition-all shadow-sm"
                  >
                    <Calculator size={14} />
                  </button>
                ) : (
      ...
      <div className="p-4 bg-slate-900 space-y-3 shrink-0">
        <div className="flex justify-between items-center mb-1">
          ...
          <span className="text-lg font-bold text-white tracking-tighter tabular-nums">
            R${' '}
        ...
        <Button
          ...
          disabled={hasBlocks}
          className={cn(
            'h-11 rounded-lg font-bold uppercase tracking-widest text-xs transition-all shadow-lg',
            hasBlocks
