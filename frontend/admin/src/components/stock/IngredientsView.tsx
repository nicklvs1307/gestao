    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="p-3 border-l-4 border-l-blue-500 bg-blue-50/10 flex items-center justify-between">
          <div>
            <p className="text-[8px] font-black text-slate-500 uppercase tracking-widest">Total Insumos</p>
        ...
        <Card className="p-3 border-l-4 border-l-amber-500 bg-amber-50/10 flex items-center justify-between">
          <div>
            <p className="text-[8px] font-black text-slate-500 uppercase tracking-widest">Estoque Crítico</p>
        ...
        <table className="w-full text-left">
          <thead className="bg-slate-50 border-b border-slate-100">
            <tr>
              ...
              <th className="px-4 py-3 text-[9px] font-black text-slate-500 uppercase tracking-widest">Grupo</th>
              <th className="px-4 py-3 text-[9px] font-black text-slate-500 uppercase tracking-widest text-center">Unidade</th>
              <th className="px-4 py-3 text-[9px] font-black text-slate-500 uppercase tracking-widest text-right">Estoque</th>
              <th className="px-4 py-3 text-[9px] font-black text-slate-500 uppercase tracking-widest text-right">Custo Médio</th>
              ...
              <tr key={item.id} className="hover:bg-slate-50/50 transition-colors group">
                <td className="px-4 py-3">
                  <div>
                    ...
                    <p className="text-[8px] font-bold text-slate-500 uppercase tracking-widest">{item.id.slice(-8)}</p>
                  </div>
                </td>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3 text-right">
                  <div className="flex justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button className="p-1.5 text-slate-500 hover:text-blue-500 bg-white border border-slate-100 rounded-lg shadow-sm transition-all">
                      <Edit2 size={12} />
                    </button>
                    <button 
                      onClick={() => handleDelete(item.id)}
                      className="p-1.5 text-slate-500 hover:text-rose-500 bg-white border border-slate-100 rounded-lg shadow-sm transition-all"
                    >
                      <Trash2 size={12} />
                    </button>
                  </div>
