                ...
                <div className="px-8 py-6 border-b bg-slate-50/50 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none">Lançamento Avulso</p>
                        </div>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            <Banknote className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-slate-900 transition-colors" size={20} />
                            <input 
                                type="number" 
                                step="0.01"
                                required
                                autoFocus
                                className="w-full h-16 pl-12 pr-4 bg-slate-50 border border-slate-200 rounded-2xl font-black text-3xl text-slate-900 focus:border-primary focus:bg-white outline-none transition-all placeholder:text-slate-200"
                                placeholder="0,00"
                                value={amount} 
                    ...
                    <button 
                        ...
                        disabled={isSaving}
                        className={cn(
                            "w-full h-14 text-white rounded-2xl font-black uppercase text-xs tracking-widest shadow-xl transition-all flex items-center justify-center gap-2",
