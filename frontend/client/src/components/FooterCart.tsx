...
const FooterCart: React.FC<FooterCartProps> = ({ items, total, onClick }) => {
  ...
  return (
    <div className="fixed bottom-18 md:bottom-6 left-4 right-4 md:left-1/2 md:-translate-x-1/2 md:max-w-lg z-[100] animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div 
        onClick={onClick}
