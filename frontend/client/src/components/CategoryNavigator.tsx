      ...
      <div className="flex gap-3 px-2">
        <button 
          ...
          className={cn(
            ...
            activeCategory === 'todos' ? "bg-primary text-white shadow-lg shadow-primary/30" : "bg-slate-100 text-slate-500 hover:bg-slate-200"
          )}
        >
        ...
        {categories.map((cat) => (
          <button 
            ...
            className={cn(
              ...
              activeCategory === cat.id ? "bg-primary text-white shadow-lg shadow-primary/30" : "bg-slate-100 text-slate-500 hover:bg-slate-200"
            )}
          >
            {cat.name}
          </button>
