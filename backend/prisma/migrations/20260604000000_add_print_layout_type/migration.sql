...
-- Step 3: Drop the old unique index on restaurantId alone
DROP INDEX IF EXISTS "print_layout_configs_restaurantId_key";
...
CREATE UNIQUE INDEX IF NOT EXISTS "print_layout_configs_restaurantId_type_key" ON "print_layout_configs"("restaurantId", "type");

-- Step 5: Add index on type for faster filtering
CREATE INDEX IF NOT EXISTS "print_layout_configs_type_idx" ON "print_layout_configs"("type");
